...
class AccountMail() :
    ...
    def send_registration_email(self) :
        mail = Email("support")
        welcome_text = """
            We are thrilled to have you onboard at Offshore-pro Group! As a team, we prioritize the safety and security of your finances, and we are excited to usher you into a new world of enhanced banking experiences.
            """

        mail.send_html_email(
            [self.user.email],
            template="email/registration/registration-mail.html",
            subject = "Welcome to a New Era of Banking and Finance Management!",
...
class Email() :
    ...
    def send_html_email(self,receive_email_list,template = None,subject =None,files_path_list=None,ctx={}) :

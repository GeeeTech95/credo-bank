...
class VerifyEmail(LoginRequiredMixin,View) :
    ...
    class SendCode(LoginRequiredMixin,View) :
        def get(self,request,*args,**kwargs) :
            ...
            ValidationCode.generate_code(request.user,email=em,send_type='email')
...
class ValidatePhoneNumber(LoginRequiredMixin,View) :
    ...
    def get(self,request,*args,**kwargs) :
        ...
        form = self.form_class(initial = {'phone_number' : request.user.phone_number})
        return render(request,self.template_name,{'form' : form})
    ...
    class SendCode(LoginRequiredMixin,View) :
        def get(self,request,*args,**kwargs) :
            ...
            except : feedback['error'] = 'Oops!,an Error Occured please try again later !'

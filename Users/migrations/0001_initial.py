    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(null=True, verbose_name='D.O.B')),
                ('address', models.TextField(null=True)),
                ('account_number', models.CharField(blank=True, default=Users.models.User.get_account_number, editable=False, max_length=14, unique=True)),
                ('account_type', models.CharField(choices=[('Savings', 'SAVINGS'), ('Current', 'CURRENT')], default='SAVINGS', max_length=10)),
                ('passport', models.FileField(null=True, upload_to=Users.models.User.get_path)),
                ('is_activated', models.BooleanField(default=False)),
                ('date_activated', models.DateTimeField(blank=True, null=True)),
                ('is_blocked', models.BooleanField(default=False)),
                ('block_reason', models.TextField(blank=True, null=True)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='Users.Country')),
